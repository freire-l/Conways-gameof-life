...
class Controller {
 public:
    ...
    void HandleInput2(bool &running, std::shared_ptr <Grid> act_grid, std::shared_ptr <Grid> next_grid, 
    ...
    void ReadOrWrite(int file_number, std::shared_ptr <Grid> act_grid, std::shared_ptr <Grid> next_grid, 
